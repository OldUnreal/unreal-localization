...
ReceiveSize="Taille du fichier %iK, %3.1f%% = %iK téléchargé"
; EN: ReceiveTotalPackages="%i of %i Packages Downloaded"
ReceiveTotalPackages="%i du %i fichiers téléchargé"
; EN: ReceiveTotalSize="Total Size %iK, Complete %3.1f%% = %iK"
ReceiveTotalSize="Taille totale %iK, %3.1f%% = %iK téléchargé"
